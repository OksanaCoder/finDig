          ...
          <Col lg={8} md={8} sm={12} xs={12}>
            <Row>
              ...
              <Col lg={8} md={8} sm={8} xs={8}>
                ...
                <small className='me-2 light-grey'>USA, Miami, Florida |</small>{" "}
                ...
                <p>
                  ...
                  id. Sed sed non porta tincidunt.. <small className='blue-color'>More</small>
                </p>
              </Col>
            </Row>
          </Col>
          <Col lg={4} md={12} sm={12} xs={12}>
              <small className='light-grey text-right'>Start price <small className='text-dark'>$200</small></small>
              <div className='mt-2 score-box'>
                  ...
                  <div  className="flex-row-between">
                     ...
                     <ul className='list-unstyled'>
                        <li>Jobs completed: <small className='blue-color'>35</small></li>
                        <li>Service Quality: <small className='blue-color'>7/9</small></li>
                        <li>Total Earning:  <small className='blue-color'>$6K+</small></li>
                        <li>Business Shared: <small className='blue-color'>40</small></li>
                        <li>Value Business: <small className='blue-color'>500K</small></li>
                     </ul>
                  </div>
              </div>
          </Col>
