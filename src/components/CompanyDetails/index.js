...
const CompanyDetails = () => {
    ...
    const [filteredPrice, SetfilteredPrice] = useState(companyItem.price);
    let [btnDisabled,SetBtnDisable]=useState(true)
    useEffect(() => {});
    const reduceValueation = () => {
        return SetfilteredPrice - 1000
    };
    if (!companyItem) {
